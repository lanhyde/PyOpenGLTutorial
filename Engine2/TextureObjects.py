...
class TexturedObjects(PyOGLApp):
    ...
    def initialize(self):
        ...
        self.plane = LoadMesh("models/plane.obj", "textures/window.png", self.program_id, GL_TRIANGLES, location=pygame.Vector3(0, 0, 0))
        self.cube = LoadMesh("models/cube.obj", "textures/crate.png", self.program_id, GL_TRIANGLES, location=pygame.Vector3(0, -1, 0))
